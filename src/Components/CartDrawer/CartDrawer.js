    ...
    <div className="CartDrawer close" id="CartDrawer">
      <div className="cart-content">
        ...
        <div className="head">
          ...
          {CART.length > 0 && <i className="fas fa-qrcode btnActive" onClick={() => setQrCode(!qrCode)}></i>}
        </div>

        <div className={`qr-code ${qrCode && "show"}`}>
          <b>Share cart</b>
          <div>
            <QRCode className="code" fgColor={"var(--toxic-color)"} value={siteURL} />
          </div>
        </div>
